                ...
                <div class="col-md-4 col-12 ">
                    <form class="d-flex justify-content-end" action="#" method="GET" id="date_range_form">
                        ...
                        <input type="text" class="form-control form-control-sm small-search date_range me-2"
                            ...
                            name="date_range">
                        <a href="{{ route('admin.report.courier') }}" class="btn btn-sm reset_button"><i
            ...
            <div class="row my-2">
                <div class="col-12">
                    <div class="table-responsive mb-4">
                        <table class="table card-table  datatable table-bordered">
                            <thead>
                                <tr>
                                    <th>SL.</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($courierReports as $key => $item)
                                    {{-- @dd($item) --}}
