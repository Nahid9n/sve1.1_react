                ...
                <div class="col-md-4 col-12 ">
                    <form class="d-flex justify-content-end" action="#" method="GET" id="date_range_form">
                        ...
                        <input type="text" class="form-control form-control-sm small-search date_range me-2"
                            ...
                            name="date_range">
                        <a href="{{ route('admin.report.account.trans') }}" class="btn btn-sm  reset_button"><i
            ...
            <div class="row my-2">
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-center datatable table-bordered">
                            <thead>
                                <tr>
                                    <th>Cash In</th>
                                    <th>CashOut</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $setting->currency_sign }}{{ $cashIn }}</td>
                                    <td>{{ $setting->currency_sign }}{{ $cashOut }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
