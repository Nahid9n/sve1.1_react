    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                ...
                <div class="col-6 d-flex align-items-end premium-form"
                    style="flex-wrap: wrap; align-content: space-around; justify-content: flex-end;">
                    <form action="{{ route('admin.customers') }}" class="d-flex align-items-start gap-2" id="search_form">
                        <div>
                            <input type="text" class="form-control form-control-sm w-100 search-input cool-select"
                                placeholder="name or phone" id="search" value="{{ request('search') }}" name="search">
                        </div>

                        <button type="submit" class="btn btn-gradient-success btn-sm d-flex align-items-center gap-1">
                                        ...
                                        @foreach ($data as $item)
                                            <tr @if ($i % 2 == 0) style="background-color:#f5f5f5" @endif>
                                                ...
                                                <td>
                                                    ...
                                                    <span><strong>Addres:</strong> {{ $item->address }}</span>
                                                </td>
                                                <td>
                                                    <?php
                                                    $total_order = $item->get_orders->count();
                                                    ?>
                                                ...
                                                <td class="w-1">
                                                    @can('customers.edit')
                                                        <a href="javascript:void(0);"
                                                            class="btn-gradient-info  border-0 btn-sm w-100 mb-1 d-flex justify-content-center align-items-center rounded gap-1 edit_customer"
