            ...
            <div class="container-fluid dashboard-content ">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h3 class="pageheader-title">Steadfast API</h3>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <form action="{{ route('admin.steadfast.api.update') }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $data->config['secret_key'] ?? null }}" name="secret_key"
                                            id="secret_key">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label class="form-label" for="api_key">API Key</label>
                                        <input type="text" class="form-control"
                                            value="{{ $data->config['api_key'] ?? null }}" name="api_key" id="api_key">
                                    </div>
                                    <div class="col-12 mb-3">
